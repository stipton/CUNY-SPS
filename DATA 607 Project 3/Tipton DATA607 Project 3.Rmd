...
#kable_styling(kable(nyu.class, "html"), bootstrap_options = "striped")
```
...
#kable_styling(kable(umuc.class, "html"), bootstrap_options = "striped")
...
#kable_styling(kable(duke.class, "html"), bootstrap_options = "striped")
...
#kable_styling(kable(berkeley.class, "html"), bootstrap_options = "striped")
...
#kable_styling(kable(txam.class, "html"), bootstrap_options = "striped")
...
##scroll_box(kable_styling(kable(full.school.set.ST, "html"), bootstrap_options = "striped"))
```
...
##kable_styling(kable(long.school.set, "html"), bootstrap_options = "striped")
